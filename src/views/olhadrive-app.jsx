...
const ScheduleView  = lazy(()=>import("./olhadrive-admin-v5").then(m=>({default:m.ScheduleView})))
const SettingsView  = lazy(()=>import("./olhadrive-admin-v5").then(m=>({default:m.SettingsView})))
const BookingsView  = lazy(()=>import("./olhadrive-bookings"))
const StudentsView  = lazy(()=>import("./olhadrive-students"))
const ServicesView  = lazy(()=>import("./olhadrive-services"))
const ChatsView     = lazy(()=>import("./olhadrive-chats"))
const TemplatesView = lazy(()=>import("./olhadrive-templates"))
const StatsView     = lazy(()=>import("./olhadrive-stats"))
