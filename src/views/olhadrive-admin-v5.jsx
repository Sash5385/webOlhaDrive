...
.slot-colored {
  background: linear-gradient(155deg, color-mix(in srgb, var(--c) 70%, #1a1a1a) 0%, color-mix(in srgb, var(--c) 42%, #1a1a1a) 100%);
  border: 1px solid color-mix(in srgb, var(--c) 82%, #1a1a1a);
  box-shadow:
            ...
            {nearbySlots.map(({min, label})=>{
              ...
              return (
                <button key={min} onClick={()=>setSlotOptions(prev=>({...prev, time: label}))} style={{
                  ...
                  color: active ? "#f59e0b" : TEXT_FAINT,
