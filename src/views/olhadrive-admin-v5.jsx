...
@keyframes pulse-ring {
  0%,100% { box-shadow: inset 3px 3px 7px rgba(0,0,0,0.55), inset -3px -3px 7px rgba(255,255,255,0.28), 0 0 0 0 rgba(255,90,60,0.6); }
  50%     { box-shadow: inset 3px 3px 7px rgba(0,0,0,0.55), inset -3px -3px 7px rgba(255,255,255,0.28), 0 0 0 6px rgba(255,90,60,0); }
}
