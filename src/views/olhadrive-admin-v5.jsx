            ...
            <SectionTitle right={
              <div style={{display:"flex",gap:8}}>
                <button onClick={()=>sendTest(meta.type)} style={{
                  ...btnBase,
                  background: testSent[meta.type] ? `linear-gradient(165deg,${GREEN}cc,${GREEN}88)` : `linear-gradient(135deg,${SURFACE_HI},${SURFACE})`,
                  color: testSent[meta.type] ? "#fff" : TEXT_DIM, boxShadow:SHADOW_OUT,
