...
.slot-colored {
  background: linear-gradient(155deg, color-mix(in srgb, var(--c) 55%, #1a1a1a) 0%, color-mix(in srgb, var(--c) 35%, #000000) 100%);
  border: 1px solid color-mix(in srgb, var(--c) 55%, #000000);
  box-shadow:
