...
function TopBar({ tab, onChange, settings, setSettings }) {
  ...
  return (
    <div style={{position:"sticky",top:0,zIndex:20}}>
      <div style={{
        padding:`max(50px, calc(4px + env(safe-area-inset-top, 0px))) 8px 4px`,
        ...
        {tab==="schedule" && settings && setSettings ? (
          ...
          <div style={{display:"flex",alignItems:"center",gap:6,flex:1}}>
            ...
            {/* Портал для кнопки «Місячний календар» — рендериться з Journal через createPortal, той самий слот що і в Розкладі */}
