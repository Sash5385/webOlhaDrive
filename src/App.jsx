...
const SettingsView  = lazy(()=>import("./views/olhadrive-settings"))
        ...
        {tab==="schedule" && settings && setSettings ? (
          <>
            ...
            <div style={{flex:"0 0 auto",display:"flex",justifyContent:"center",alignItems:"center",padding:"0 6px"}}>
              <img src="/icon-192.png" alt="OlhaDrive" style={{width:26,height:26,borderRadius:"50%",flexShrink:0,boxShadow:"-2px 3px 8px rgba(0,0,0,0.45)"}}/>
            </div>
          ...
          <div style={{display:"flex",alignItems:"center",gap:6,flex:1}}>
            <img src="/icon-192.png" alt="OlhaDrive" style={{width:22,height:22,borderRadius:"50%",flexShrink:0,boxShadow:"-2px 3px 8px rgba(0,0,0,0.45)"}}/>
...
export default function App() {
  ...
  const [tab,        setTab]      = useState(() => localStorage.getItem('adminTab') || "schedule");
  ...
  useEffect(() => {
    ...
    window.addEventListener("olhadrive-nav", nav);
    return () => window.removeEventListener("olhadrive-nav", nav);
  }, []);
